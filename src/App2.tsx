      ...
      <header className="App-header">
        ...
        <form onSubmit={formSubmit}>
          <div className="form-layout-centered">
            {/* Top section: Large image uploader */}
            <div className="image-upload-section">
              <label className="form-label-large">Choose An Image Of Rash</label>
              
              {/* Large preview box */}
              <div className="image-preview-box-large">
                {!filebase64 ? (
                  <div className="placeholder-box-large">
                    Image preview will appear here
                  </div>
                ) : (
                  <img src={filebase64} alt="Uploaded preview" className="preview-image-large" />
                )}
              </div>
